...
ALLOWED_FILES_RE='(scripts/deploy/verify-rahma-(cluster|repo)\.sh|scripts/k3s/(deploy|delete)-sakina-staging\.sh|deployment/k3s/backend/sakina-backend-deployment\.yaml|deployment/k3s/rahma/00-namespace\.yaml|deployment/k3s/rahma/data/secrets\.example\.yaml|deployment/k3s/README\.SERVER\.md|deployment/k3s/scripts/(deploy|verify|rollback)-rahma-mobile-infra\.sh|\.github/workflows/rahma-security-scan\.yml|backend/app/test/sprint-27-db\.test\.js|backend/app/test/sprints-20-24\.test\.js|docs/ops/(DATABASE_LOCAL_VERIFICATION|K3S_DEPLOYMENT_VERIFICATION)\.md|docs/RAHMA_PROJECT_(STATUS|REMAINING_WORK_AND_SPRINT_PLAN)\.md|docs/infra/RAHMA_(K3S_DEPLOYMENT_RUNBOOK|MASTER_ACCESS_RECOVERY|DNS_TLS_CHECKLIST|INFRA_VARIABLES|MOBILE_K3S_RUNBOOK|SECRETS_REQUIRED|PUBLIC_API_EXPOSURE_LATER)\.md|docs/wasm/RAHMA_WASM_(ARCHITECTURE|SERVICE_CONTRACTS|LIMITATIONS)\.md|docs/api/RAHMA_(MOBILE_API_(CONTRACT|OPENAPI)|AUTH_CONTRACT|SHEIKH_WORKFLOW_API|CHILDREN_GAME_API|QURAN_HADITH_DUA_API|READY_CONTRACT|OPENAPI_CONTRACT_REPORT)\.(md|yaml)|docs/api/openapi/rahma-mobile-api\.yaml|docs/mobile/RAHMA_(MOBILE_BUILD_PLAN|ANDROID_IOS_RELEASE_PLAN|APP_STORE_REQUIREMENTS|MOBILE_STACK_DECISION|MOBILE_APP_ARCHITECTURE|MOBILE_SCREEN_MAP|MOBILE_STATE_MANAGEMENT|MOBILE_OFFLINE_STRATEGY)\.md|docs/security/RAHMA_(AUTH_ARCHITECTURE|SHEIKH_ACCESS_MODEL|MOBILE_SESSION_SECURITY)\.md|docs/content/RAHMA_(ISLAMIC_SOURCE_POLICY|QURAN_SOURCE_PLAN|HADITH_SOURCE_PLAN|DUA_SOURCE_PLAN)\.md|docs/ops/RAHMA_(BACKUP_RESTORE_RUNBOOK|INTERNAL_HEALTHCHECK_RUNBOOK|INCIDENT_RESPONSE_RUNBOOK)\.md|docs/infra/RAHMA_(REAL_IMAGE_DEPLOYMENT_RUNBOOK|OPERATOR_ROLLOUT_COMMANDS|DB_MIGRATION_RUNBOOK|API_IMAGE_ROLLOUT_OPERATOR_GUIDE|LIVE_DB_MIGRATION_OPERATOR_RUNBOOK)\.md|docs/wasm/RAHMA_WASM_(RUNTIME_DECISION|DEPLOYMENT_PLAN)\.md|docs/wasm/RAHMA_CHILD_SAFETY_RUNTIME_PROTOTYPE\.md|docs/ops/RAHMA_OPERATOR_APPLY_OPS_UPDATES\.md|docs/security/RAHMA_SECRET_ROTATION_RUNBOOK\.md|docs/payments/RAHMA_DONATION_(PROVIDER_DECISION|SECURITY_MODEL|AUDIT_MODEL)\.md|docs/content/(RAHMA_CONTENT_IMPORT_RUNBOOK|examples/source-metadata\.example\.json)|docs/mobile/RAHMA_(FLUTTER_SETUP|MOBILE_ENV_CONFIG)\.md|docs/future/(rahma-api-ingress\.yaml\.future|50-backend-ingress\.yaml\.future|sakina-backend-ingress\.yaml\.future|README\.md)|reports/RAHMA_BUNDLE_(01|02|03)_|reports/RAHMA_MOBILE_INFRA_FINAL_REPORT\.md|reports/RAHMA_MOBILE_DELIVERY_FOUNDATION_REPORT\.md|reports/RAHMA_SPRINT_(41|43|49|51|52|53|54|55|57|59|61|62|63|64|65|66|68|69)_|reports/RAHMA_API_ROLLOUT_|scripts/security/rahma-release-security-gate\.sh|docs/release/RAHMA_RC1_PLAN\.md|docs/release/RAHMA_PUBLIC_API_READINESS_CHECKLIST\.md|docs/release/RAHMA_MOBILE_APP_READINESS_CHECKLIST\.md|docs/security/RAHMA_(PRIVACY_MODEL|CHILD_DATA_PROTECTION|API_SECURITY_RELEASE_GATE|THREAT_MODEL_MOBILE_API|AUTH_IMPLEMENTATION_FOUNDATION)\.md|docs/wasm/RAHMA_CHILD_SAFETY_IMAGE_ROLLOUT\.md|docs/api/RAHMA_(READY_V2_CONTRACT|SHEIKH_WORKFLOW_V1)\.md|docs/infra/RAHMA_DB_SEED_RUNBOOK\.md|docs/mobile/RAHMA_(OFFLINE_FIRST_DESIGN|SYNC_CONFLICT_POLICY|MOBILE_MVP_SHELL_REPORT)\.md)'
